...
const WeatherGet = () => {
    ...
    const api = 'e9e3c4be98a14bfc92b55336242210'
    // 😀

    const getWeather = async () => {
        try {
            const response = await axios.get(`http://api.weatherapi.com/v1/current.json?key=${api}&q=${city}&aqi=no`)
            // const response = await axios.get('http://api.weatherapi.com/v1/current.json?key=e9e3c4be98a14bfc92b55336242210&q=${city}&aqi=no')
